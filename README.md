...
> **Microsoft Activation Scripts v3.10** + **IDM Activation** + **WinRAR Activation** — Tất cả trong một script duy nhất.
...
- MAS_AIO.cmd dựa trên [Microsoft Activation Scripts v3.10](https://massgrave.dev) by massgrave.dev
